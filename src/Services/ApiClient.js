...
class ApiClient {
  ...
  async loadownerDetails() {
    return await this.request({
      endpoint: `ownerauth/getownerdetails`,
      method: `GET`,
    });
  }
  async registerDriver(credentials) {
    return await this.request({
      endpoint: `ownerauth/registerDriver`,
      method: `POST`,
      data: credentials,
    });
  }
  async EditOwnerProfile(credentials) {
    ...
    return await this.request({
      endpoint: `ownerauth/EditOwnerProfile`,
      method: `POST`,
      data: credentials,
    });
  }
  async loadDriversDetails() {
    return await this.request({
      endpoint: `ownerauth/getdriverdetails`,
      method: `GET`,
    });
  }
  async EditOwnerDriverProfile(credentials) {
    console.log(credentials);
    return await this.request({
      endpoint: `ownerauth/EditOwnerDriverProfile`,
      method: `POST`,
      data: credentials,
    });
  }
  ...
  async removeDriver(credentials) {
    console.log(credentials);
    return await this.request({
      endpoint: `ownerauth/removeDriver`,
      method: `POST`,
      data: credentials,
    });
  }
  async getDriverDetails(credentials) {
    console.log(credentials);
    return await this.request({
      endpoint: `ownerauth/loadDriverDetails`,
      method: `POST`,
      data: credentials,
    });
  }
  async registersclvan(credentials) {
    console.log(credentials);
    return await this.request({
      endpoint: `ownerauth/registersclvan`,
      method: `POST`,
      data: credentials,
    });
  }
  async addSchoolstoSchoolvan(credentials) {
    console.log(credentials);
    return await this.request({
      endpoint: `ownerauth/addSchoolstoSchoolvan`,
      method: `POST`,
      data: credentials,
    });
  }
  async isuniquevehicleno(credentials) {
    console.log(credentials);
    return await this.request({
      endpoint: `ownerauth/isuniquevehicleno`,
      method: `POST`,
      data: credentials,
    });
  }
  async getschoolvandetails() {
    return await this.request({
      endpoint: `ownerauth/getschoolvandetails`,
      method: `GET`,
    });
  }
  async getschoolsSchoolvan() {
    return await this.request({
      endpoint: `ownerauth/getschoolsSchoolvan`,
      method: `GET`,
    });
  }
  async updatesclvanDetails(credentials) {
    return await this.request({
      endpoint: `ownerauth/updatesclvanDetails`,
      method: `POST`,
      data: credentials,
    });
  }
  async removeSchoolstoSchoolvan(credentials) {
    return await this.request({
      endpoint: `ownerauth/removeSchoolstoSchoolvan`,
      method: `POST`,
      data: credentials,
    });
  }
  async assignnewdriver(credentials) {
    return await this.request({
      endpoint: `ownerauth/assignnewdriver`,
      method: `POST`,
      data: credentials,
    });
  }
  ...
  async getOwnersAdDetails() {
    return await this.request({
      endpoint: `ownerauth/getOwnersAdDetails`,
      method: `GET`,
    });
  }
  async getAllAdDetails() {
    return await this.request({
      endpoint: `ownerauth/getAllAdDetails`,
      method: `GET`,
    });
  }
  async getAdDetailsSchools(credentials) {
    return await this.request({
      endpoint: `ownerauth/getAdDetailsSchools`,
      method: `POST`,
      data: credentials,
    });
  }
  async getAdDetailsImages(credentials) {
    return await this.request({
      endpoint: `ownerauth/getAdDetailsImages`,
      method: `POST`,
      data: credentials,
    });
  }
  async InsertAdImage(credentials) {
    return await this.request({
      endpoint: `ownerauth/InsertAdImage`,
      method: `POST`,
      data: credentials,
    });
  }
  async InsertAdDetails(credentials) {
    return await this.request({
      endpoint: `ownerauth/InsertAdDetails`,
      method: `POST`,
      data: credentials,
    });
  }
  async getCount() {
    return await this.request({
      endpoint: `ownerauth/getCount`,
      method: `GET`,
    });
  }
  async removeAd(credentials) {
    return await this.request({
      endpoint: `ownerauth/removeAd`,
      method: `POST`,
      data: credentials,
    });
  }
  async getRequestDetails() {
    return await this.request({
      endpoint: `ownerauth/getRequestDetails`,
      method: `GET`,
    });
  }
  async EditMonthlyCharge(credentials) {
    return await this.request({
      endpoint: `ownerauth/EditMonthlyCharge`,
      method: `POST`,
      data: credentials,
    });
  }
  async AcceptRequest(credentials) {
    return await this.request({
      endpoint: `ownerauth/AcceptRequest`,
      method: `POST`,
      data: credentials,
    });
  }
  async RejectRequest(credentials) {
    return await this.request({
      endpoint: `ownerauth/RejectRequest`,
      method: `POST`,
      data: credentials,
    });
  }
  async getTotalIncome() {
    return await this.request({
      endpoint: `ownerauth/getTotalIncome`,
      method: `GET`,
    });
  }
  async getCurrentIncome() {
    return await this.request({
      endpoint: `ownerauth/getCurrentIncome`,
      method: `GET`,
    });
  }
  async getYetToPayList() {
    return await this.request({
      endpoint: `ownerauth/getYetToPayList`,
      method: `GET`,
    });
  }
  async getUnpaidList() {
    return await this.request({
      endpoint: `ownerauth/getUnpaidList`,
      method: `GET`,
    });
  }
  async BanAStudent(credentials) {
    return await this.request({
      endpoint: `ownerauth/BanAStudent`,
      method: `POST`,
      data: credentials,
    });
  }
  async RemoveAStudent(credentials) {
    return await this.request({
      endpoint: `ownerauth/removeAStudent`,
      method: `POST`,
      data: credentials,
    });
  }
  async UnbanAStudent(credentials) {
    return await this.request({
      endpoint: `ownerauth/UnbanAStudent`,
      method: `POST`,
      data: credentials,
    });
  }
  async getcomplaints() {
    return await this.request({
      endpoint: `ownerauth/getcomplaints`,
      method: `GET`,
    });
  }
  async getReviews() {
    return await this.request({
      endpoint: `ownerauth/getReviews`,
      method: `GET`,
    });
  }
  async getStudentDetails(credentials) {
    return await this.request({
      endpoint: `ownerauth/getStudentDetails`,
      method: `POST`,
      data: credentials,
    });
  }
  ...
  async getdestinationSchools(credentials) {
    return await this.request({
      endpoint: `user/destinationschools`,
      method: `POST`,
      data: credentials,
    });
  }
  async getrequestSchools(credentials) {
    return await this.request({
      endpoint: `parent/requestschoolchildren`,
      method: `POST`,
      data: credentials,
    });
  }
  ...
  async getpendingRequest() {
    return await this.request({
      endpoint: `admin/pendingrequest`,
      method: `GET`,
    });
  }
  async getcancelledRequest() {
    return await this.request({
      endpoint: `admin/cancelledrequest`,
      method: `GET`,
    });
  }
  async acceptRequest(credentials) {
    return await this.request({
      endpoint: `admin/acceptrequest`,
      method: `POST`,
      data: credentials,
    });
  }
  async getOwnersDetails() {
    return await this.request({
      endpoint: `admin/ownersdetails`,
      method: `GET`,
    });
  }
  async getOwnersVanDetails(credentials) {
    return await this.request({
      endpoint: `admin/adminownersvandetails`,
      method: `POST`,
      data: credentials,
    });
  }
  async getAdminComplaints() {
    return await this.request({
      endpoint: `admin/admincomplaints`,
      method: `GET`,
    });
  }
}
...
const API = new ApiClient(
  process.env.REACT_APP_REMOTE_HOST_URL ||
    "https://surakimaga-deploy.herokuapp.com"
);
