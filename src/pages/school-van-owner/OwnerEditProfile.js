    ...
    const [formData, setFormData]=useState({
      ...
      useEffect(() => {
        async function getownerdetails() { 
            ...
            console.log(data)
            // console.log("dilshi")
            setFormData({ name:data.result.name,contact:data.result.contact,email:data.result.email,nic:data.result.nic,bank_acc:data.result.bank_acc,scl_service_regno:data.result.scl_service_regno,experience:data.result.experience })
        }
        getownerdetails();
    }, []);
